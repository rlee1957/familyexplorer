...
function sql_shell($sql, $params, $path)
{
...
function exe_shell($sql, $params, $path)
{
	
$res = exe($sql, $params, $path);
return $res;	
...
include($path."../_common/configuration/_mysql_credentials.php");
include($path."configuration/database_settings.php");
