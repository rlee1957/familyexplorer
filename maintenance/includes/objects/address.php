<div>
<form id=frmAddress name=frmAddress target=work method=post action="<?php echo($action); ?>">
<div>
<table>
	<tr>
...
<table>
	...
	<tr>
		<td align=right>&nbsp;</td>
		<td><input type=button onclick="check_address('frmAddress');" value="Submit" /></td> 
	</tr>
</table>
</div>
